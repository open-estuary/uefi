...
//
// EHCI register base address
//
#define M3_SUB_BASE_ADDRESS (0xA0000000)

#define EHCI_BASE_ADDRESS   (M3_SUB_BASE_ADDRESS + 0x01000000)
#define OHCI_BASE_ADDRESS   (M3_SUB_BASE_ADDRESS + 0x01010000)
...
#define EHC_HCIVERSION_OFFSET   0x02 // EHCI Version register offset
